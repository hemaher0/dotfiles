# Generated by Powerlevel10k configuration wizard on 2026-02-06 at 22:19 KST.
...
() {
  ...
  # Unset all configuration options. This allows you to sync configuration changes without
  ...
  # Wait a little longer for the initial gitstatus response on MSYS2 so the first prompt
  # usually includes the VCS segment instead of popping it in asynchronously.
